...
public class EveningSlotAdpater extends RecyclerView.Adapter<EveningSlotAdpater.ViewHolder> {
    ...
    public EveningSlotAdpater(Context context, ArrayList<TimeSlot> model, Select listener) {
    ...
    public interface Select {
        void Click(String status, TimeSlot model);
    }
